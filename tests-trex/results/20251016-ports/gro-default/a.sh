#!/bin/bash
SUBDIR=results/20251016-ports/gro-default/
mkdir -p $SUBDIR
...
./u1.py --pps 3M --frame-size 128 --dst-ports 16 --duration 30 --csvfile $SUBDIR/trex-flows-16-frame-size-128-xfrm
...
./u1.py --pps 3M --frame-size 128 --dst-ports 512 --duration 30 --csvfile $SUBDIR/trex-flows-512-frame-size-128-xfrm
./u1.py --pps 3M --frame-size 128 --dst-ports 1024 --duration 30 --csvfile $SUBDIR/trex-flows-1014-frame-size-128-xfrm
