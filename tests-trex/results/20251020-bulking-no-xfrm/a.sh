...
mkdir -p $SUBDIR
./u1.py --pps 16M --flows-end 10 --frame-size 128 --duration 30 --csvfile $SUBDIR/both-bulk
./u1.py --pps 25M --flows-start 11 --flows-end 15 --frame-size 128 --duration 30 --csvfile $SUBDIR/both-bulk-11
